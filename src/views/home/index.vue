...
<template>
  ...
  <div class="change-device-message barlow-medium" id="error-message">
    <p data-aos="fade-up" class="barlow-extralight text-center extra-break">
      Your email is registered to a another device. Would you like to shift to this devices for
      notifications?
    </p>

    <div data-aos="fade-up" class="button-maker">
      <div class="barlow-thin button-text" id="change-deviceID">Yes</div>
    </div>

    <div data-aos="fade-up" class="button-maker">
      <div class="barlow-thin button-text" id="no-change-deviceID">No</div>
    </div>
  </div>
  ...
  <div class="main-menu">
    ...
    <div class="main-menu-item-holder">
      ...
      <h2 class="barlow-extralight text-center" id="links">
        <a href="./morelinks.html">Our Feed</a>
      </h2>
    ...
    <img src="@/styles/images/menu-image.svg" class="main-menu-image" alt="Open Menu" />
  </div>
  ...
  <div class="navbar">
    ...
    <div class="menu barlow-extralight">
      <div class="menu-item" id="home-desk">Home</div>
      ...
      <div class="menu-item" id="updates-desk">Updates</div>
      <div class="menu-item" id="team-desk">
      ...
      <div class="menu-item" id="contact-desk">Contact Us</div>
    </div>
  ...
  <div class="main" id="home-scroll">
    <div class="main-text-holder">
      <div class="main-text-holder-heading">
        <img data-aos="fade-up" src="@/styles/images/DSClogo.svg" class="logo" alt="GDSC VIT" />
        <img
          data-aos="fade-up"
          src="@/styles/images/DSClogo.svg"
          class="logo-light"
      ...
      <p data-aos="fade-up" class="barlow-extralight continous-text">
        At GDSC VIT, our aim is to learn and teach. Developers, designers and managers come together
        under one roof to create a community which inspires thousands. Join Us!
      </p>
    </div>
    ...
    <img src="@/styles/images/landing.svg" class="main-image" alt="Home Page" />
  </div>

  <div class="container-main holded-container" id="our-work-scroll">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Our Focus</h1>
    ...
    <p data-aos="fade-up" class="barlow-extralight text-center">
      That said, we conduct two flagship events, namely, DevFest and WomenTechies, and tons of
      insightful workshops!
    </p>
  </div>

  <div class="container-main holded-container" id="team-scroll">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Get to know the team</h1>

    <p data-aos="fade-up" class="barlow-extralight text-center extra-break">
      We’ve got a strong team filled with caffeine addicted developers, gradients loving designers
      and machine like working managers.
    </p>

    <a href="./team.html">
      <div data-aos="fade-up" class="button-maker">
        <div class="barlow-thin button-text">The Team</div>
      </div>
    </a>
  </div>
  ...
  <div class="container-main holded-container" id="updates-scroll">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Updates</h1>

    <p data-aos="fade-up" class="barlow-extralight text-center extra-break">
      We are actively conducting workshops, and also contributing to the development side by
      churning out high quality projects.
    </p>

    <div data-aos="fade-up" class="buttons">
      <a href="https://github.com/GDGVIT" target="_blank" rel="noopener">
        <div class="button-maker" id="projects-button">
          <div class="barlow-thin button-text">Projects</div>
        </div>
      </a>

      <!-- <a href="https://devjams.dscvit.com" target="_blank" rel="noopener">
  ...
  <div class="container-main holded-container" id="updates-scroll">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Our Blogs</h1>

    <p data-aos="fade-up" class="barlow-extralight text-center extra-break">
      Our prime focus is to learn and disseminate knowledge. Our team roll out blogs regularly on
      medium.
    </p>
    ...
    <div data-aos="fade-up" class="buttons">
      <a href="./blogs.html">
        <div class="button-maker" id="projects-button">
          <div class="barlow-thin button-text">Check out</div>
        </div>
      </a>
  ...
  <div class="container-main holded-container" id="contact-scroll">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Contact us</h1>
    ...
    <div data-aos="fade-up" class="icons small-icons">
      <a href="https://www.instagram.com/gdscvitvellore/" target="_blank" rel="noopener">
        <img src="@/styles/images/Instagram.svg" class="circle-icon spc" alt="GDSC VIT Instagram" />
      </a>

      <a href="https://twitter.com/gdscvit" target="_blank" rel="noopener">
        <img src="@/styles/images/Twitter.svg" class="circle-icon spc" alt="GDSC VIT Twitter" />
      </a>

      <a href="https://www.linkedin.com/company/dscvit" target="_blank" rel="noopener">
        <img src="@/styles/images/Linkedin.svg" class="circle-icon spc" alt="GDSC VIT Linkedin" />
      </a>

      <a href="https://www.facebook.com/gdscvitvellore" target="_blank" rel="noopener">
        <img src="@/styles/images/Facebook.svg" class="circle-icon spc" alt="GDSC VIT Facebook" />
      </a>

      <a href="https://github.com/GDGVIT" target="_blank" rel="noopener">
        <img src="@/styles/images/Github.svg" class="circle-icon spc" alt="GDSC VIT GitHub" />
      </a>

      <a href="https://www.behance.net/dsc-vit" target="_blank" rel="noopener">
        <img src="@/styles/images/Behance.svg" class="circle-icon spc" alt="GDSC VIT Behance" />
      </a>

      <a href="https://medium.com/gdg-vit" target="_blank" rel="noopener">
        <img src="@/styles/images/Medium.svg" class="circle-icon spc" alt="GDSC VIT Medium" />
      </a>
      <a
        ...
        rel="noopener"
      >
        <img src="@/styles/images/Youtube.svg" class="circle-icon spc" alt="GDSC VIT Youtube" />
      </a>
      <a href=" https://discord.gg/4VqH3RJQXG" target="_blank" rel="noopener">
        <img src="@/styles/images/Discord.svg" class="circle-icon spc" alt="GDSC VIT Youtube" />
      </a>
  ...
  <div class="container-main holded-container">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Submit an idea</h1>

    <p data-aos="fade-up" class="barlow-extralight text-center extra-break">
      Didn’t get the chance to implement your favourite idea? Why not give us a chance to bring it
      to real life.
    </p>

    <a href="http://ideas.dscvit.com/" target="_blank" rel="noopener">
      <div data-aos="fade-up" class="button-maker">
        <div class="barlow-thin button-text">Submit idea</div>
      </div>
    </a>
  </div>

  <div class="container-main holded-container" id="stayupdated">
    <h1 data-aos="fade-up" class="barlow-medium text-center">Stay Updated</h1>

    <p data-aos="fade-up" class="barlow-extralight text-center extra-break">
      Want to stay updated with the latest news about GDSC VIT? Enter you email address and allow
      notifications.
    </p>
    ...
    <div data-aos="fade-up" class="button-maker" id="get-updates">
      <div class="barlow-thin button-text">Get Updates</div>
    </div>
  </div>
