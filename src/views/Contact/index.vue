<template>
  <div class="contact-container">
    ...
    <section class="office-section">
      <h2 class="section-title">全球办公室</h2>
...
const partners = [
  ...
  },
  {
    id: 3,
    name: 'Amazon',
    logo: '/src/assets/images/partners/amazon.svg'
  },
  {
    id: 4,
    name: 'Apple',
    logo: '/src/assets/images/partners/apple.svg'
  }
]
</script>
...
.ai-icon { background: linear-gradient(135deg, #6366F1, #818CF8); }
.knowledge-icon { background: linear-gradient(135deg, #10B981, #34D399); }
.support-icon { background: linear-gradient(135deg, #F59E0B, #FBBF24); }
